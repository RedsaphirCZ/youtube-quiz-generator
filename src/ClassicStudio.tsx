...
export default function ClassicStudio({ onExit }: { onExit: () => void }) {
  type AppView = 'home' | 'library' | 'play' | 'summary';
  ...
  if (appView === 'home') {
    return (
      <LandingPage onStartQuiz={handleSelectQuiz} onBrowseQuizzes={openLibrary} onExitToModes={onExit} />
    );
  }
